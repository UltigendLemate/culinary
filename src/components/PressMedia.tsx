    ...
    return (
        <div id="Press" className='bg-gray-50 py-16 px-4 sm:px-6 lg:px-8'>
            <div className='max-w-7xl mx-auto'>
                ...
                {/* Main Content Card */}
                <div className='bg-white rounded-2xl shadow-lg overflow-hidden border-l-4 border-primary'>
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <div className='space-y-3'>
                                        <div className='flex items-center'>
                                            ...
                                            <a href="tel:+919869100555" className='text-gray-700 hover:text-primary transition-colors'>
                                                (+91) 9869 100 555
                                            </a>
                                        </div>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <a href="mailto:shraddha.jadhav@ashwinipublicity.com" className='text-gray-700 hover:text-primary transition-colors text-sm'>
                                        ...
                                        <div className='flex items-center'>
                                            ...
                                            <a href="https://www.ashwinipublicity.com" target="_blank" rel="noopener noreferrer" className='text-gray-700 hover:text-primary transition-colors'>
