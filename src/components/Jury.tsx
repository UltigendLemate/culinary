...
const Jury = () => {
  const jury = [
    ...
    {
      "name": "Chef Vineet Manocha",
      "img": "/judges/vineet.jpg",
      "text": "Chef Vineet Manocha, Head - Culinary Innovation & Production, Devyani International Ltd., has tapped his global experience to make signature dining a reality in all his endeavours. His interests and achievements go beyond simply a Chef's normal kitchen profile. An alumnus of IHM Pusa, Vineet's experience of over 30 years includes management tenures at renowned chains like Oberoi, Hyatt and Radisson hotels. Setting up F&B retail concepts is Vineet's strength. He has helped setting up more than 250 restaurants in recent years. He is adept in heading large multi-cultural operations across the world. Vineet is also an avid trainer, F&B strategist, team builder and has been conferred the \"Golden Hat – 2022\" and \"Rashtriya Gaurav Award\" for outstanding services, achievements, and contributions to Culinary."
    },
  ]
  ...
  return (
    <div className='w-full pt-10 pb-20' id='Jury'>
      ...
      <div className='md:mx-24 mx-10 mt-10 grid grid-cols-1 sm:grid-cols-2 gap-10'>
