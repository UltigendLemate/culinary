...
export default function Contact() {
  ...
  const sendEmail = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    templateParams.website = "culinary";
  ...
  return (
    <div id="Contact" className="font-mon px-3 py-5 mb-10 mt-10">
      <h1 className="text-5xl md:text-7xl  text-center  heading">
        CONTACT US
      </h1>

      <section className="py-5 overflow-hidden relative z-10 md:mt-7">
        <div className="md:mx-24 mx-10">
          <div className="flex flex-wrap lg:justify-between w-full flex-col-reverse md:flex-row">
            <div className="w-full mt-7 md:mt-0 lg:w-1/2 xl:w-[50%] ">
                ...
                <form ref={form} onSubmit={sendEmail}>
                  ...
                  <div>
                    <button
                      ...
                      disabled={isLoading}
                      className="
                  lg:text-base text-base w-full bg-primary text-primary-foreground mb-2 lg:mb-0 rounded-lg  p-2 lg:px-6 text-center font-semibold hover:cursor-pointer underline-offset-8 transition-all duration-40 flex items-center justify-center disabled:opacity-75 disabled:cursor-not-allowed
                        "
                    >
                      {isLoading ? (
                ...
                <div className="mb-8 flex w-full max-w-[370px] ">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-body-color md:text-lg text-base">
                      +91 9811136837 <br/> +91 9810315463
                    </p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px] ">
